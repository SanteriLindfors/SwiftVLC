...
let package = Package(
  ...
  targets: [
    .binaryTarget(
      name: "libvlc",
      url: "https://github.com/SanteriLindfors/SwiftVLC/releases/download/v0.13.0/libvlc.xcframework.zip",
      checksum: "da986c5b908e1b1117a3aa304643b641aad121aad08649975f27b99fb70b7dfa"
    ),
    .target(
      name: "CLibVLC",
      dependencies: ["libvlc"],
